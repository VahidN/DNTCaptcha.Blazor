...
public class HumanReadableIntegerProvider : ICaptchaTextProvider
{
    private readonly IDictionary<NumberToWordLanguage, string> _and = new Dictionary<NumberToWordLanguage, string>
    {
        ...
        {
            NumberToWordLanguage.Azerbaijani, " "
        }
    };
    ...
    private readonly IDictionary<NumberToWordLanguage, string> _negative = new Dictionary<NumberToWordLanguage, string>
    {
        ...
        {
            NumberToWordLanguage.Azerbaijani, "Neqativ"
        }
    };
    ...
    private readonly IList<NumberWord> _numberWords = new List<NumberWord>
    {
        ...
        {
            Group = DigitGroup.Ones,
            Language = NumberToWordLanguage.Norwegian,
            Names = new List<string>
            {
                string.Empty,
                "en",
        ...
        {
            Group = DigitGroup.Ones,
            Language = NumberToWordLanguage.Italian,
            Names = new List<string>
            {
                string.Empty,
                "Uno",
        ...
        {
            Group = DigitGroup.Ones,
            Language = NumberToWordLanguage.Turkish,
            Names = new List<string>
            {
                string.Empty,
                "Bir",
        ...
        {
            Group = DigitGroup.Ones,
            Language = NumberToWordLanguage.Arabic,
            Names = new List<string>
            {
                string.Empty,
                "واحد",
        ...
        {
            Group = DigitGroup.Ones,
            Language = NumberToWordLanguage.Russian,
            Names = new List<string>
            {
                string.Empty,
                "Один",
        ...
        {
            Group = DigitGroup.Ones,
            Language = NumberToWordLanguage.Chinese,
            Names = new List<string>
            {
                string.Empty,
                "一",
        ...
        {
            Group = DigitGroup.Ones,
            Language = NumberToWordLanguage.Spanish,
            Names = new List<string>
            {
                string.Empty,
                "Uno",
        ...
        {
            Group = DigitGroup.Ones,
            Language = NumberToWordLanguage.Portuguese,
            Names = new List<string>
            {
                string.Empty,
                "Um",
        ...
        {
            Group = DigitGroup.Ones,
            Language = NumberToWordLanguage.French,
            Names = new List<string>
            {
                string.Empty,
                "Un",
        ...
        {
            Group = DigitGroup.Ones,
            Language = NumberToWordLanguage.German,
            Names = new List<string>
            {
                string.Empty,
                "Eins",
        ...
        {
            Group = DigitGroup.Ones,
            Language = NumberToWordLanguage.Dutch,
            Names = new List<string>
            {
                string.Empty,
                "Een",
        ...
        {
            Group = DigitGroup.Ones,
            Language = NumberToWordLanguage.Azerbaijani,
            Names = new List<string>
            {
                string.Empty,
                "Bir",
    ...
    private readonly IDictionary<NumberToWordLanguage, string> _zero = new Dictionary<NumberToWordLanguage, string>
    {
        ...
        {
            NumberToWordLanguage.Azerbaijani, "Sıfır"
        }
    };
    ...
    public string GetText(int number, NumberToWordLanguage language) => NumberToText(number, language);
    ...
    /// <param name="language">local language</param>
    /// <returns>the equivalent text</returns>
    public string NumberToText(int number, NumberToWordLanguage language) => NumberToText((long)number, language);
    ...
    /// <param name="language">local language</param>
    /// <returns>the equivalent text</returns>
    public string NumberToText(uint number, NumberToWordLanguage language) => NumberToText((long)number, language);
    ...
    /// <param name="language">local language</param>
    /// <returns>the equivalent text</returns>
    public string NumberToText(byte number, NumberToWordLanguage language) => NumberToText((long)number, language);
    ...
    /// <param name="language">local language</param>
    /// <returns>the equivalent text</returns>
    public string NumberToText(decimal number, NumberToWordLanguage language) => NumberToText((long)number, language);
    ...
    /// <param name="language">local language</param>
    /// <returns>the equivalent text</returns>
    public string NumberToText(double number, NumberToWordLanguage language) => NumberToText((long)number, language);
