...
namespace DNTCaptcha.Blazor
{
    ...
    public partial class DntInputCaptcha : ComponentBase, IDisposable, IAsyncDisposable
    {
        ...
        /// </summary>
        [Parameter] public TimeSpan AbsoluteExpiration { get; set; } = TimeSpan.FromMinutes(2);

        /// <summary>
        /// Shows thousands separators such as 100,100,100 in ShowDigits mode.
        /// Its default value is true.
        /// </summary>
        [Parameter] public bool AllowThousandsSeparators { get; set; } = true;

        /// <summary>
        /// The CSS class of the captcha's canvas.
		/// Its default value is ``.
        /// </summary>
        [Parameter] public string CaptchaCanvasClass { get; set; } = "";

        /// <summary>
        /// The CSS class of the captcha's DIV.
		/// Its default value is `d-flex justify-content-center align-self-center ms-1`.
        /// </summary>
        [Parameter] public string CaptchaDivClass { get; set; } = "d-flex justify-content-center align-self-center ms-1";

        /// <summary>
        /// The language of the captcha. It's default value is Persian.
        /// </summary>
        [Parameter] public NumberToWordLanguage Language { set; get; } = NumberToWordLanguage.Persian;

        /// <summary>
        /// Display mode of the captcha's text. It's default value is NumberToWord.
        /// </summary>
        [Parameter] public DisplayMode DisplayMode { set; get; }

        /// <summary>
        /// The max value of the captcha. It's default value is 9000.
        /// </summary>
        [Parameter] public int Max { set; get; } = 9000;

        /// <summary>
        /// The min value of the captcha. It's default value is 1.
        /// </summary>
        [Parameter] public int Min { set; get; } = 1;

        /// <summary>
        /// The refresh-button-class of the captcha. It's default value is `bi-arrow-repeat btn-lg`.
        /// </summary>
        [Parameter] public string RefreshButtonClass { set; get; } = "bi-arrow-repeat btn-lg";

        /// <summary>
        /// The title of refresh-button of the captcha. It's default value is `refresh`.
        /// </summary>
		[Parameter] public string RefreshButtonTitle { set; get; } = "Refresh";
        ...
        internal ValueTask ShowCaptchaAsync()
        {
            ...
            var (text, randomNumber) = CaptchaTextFactory.GetData(Min, Max, AllowThousandsSeparators, Language, DisplayMode);
